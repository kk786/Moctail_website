...
import {cocktailLists2} from "../../constants/index.js";
...
function Menu() {
    ...
    const totalCocktails = cocktailLists2.length;
    ...
    const getCocktailAt = (indexOffset) => {
        return cocktailLists2[(currentIndex + indexOffset + totalCocktails) % totalCocktails];
    }
    ...
    return (
        <section id='menu' aria-labelledby='menu-heading'>
            ...
            <nav className='cocktail-tabs' aria-label='Cocktail Navigation'>
                {cocktailLists2.map((cocktail, index) => {
